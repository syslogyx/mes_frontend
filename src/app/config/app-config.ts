export class AppConfig {
    ...
    static readonly BASE_URL_HOST_PORT: string = "http://172.16.2.46:8089/mes/api/";
    static readonly BASE_LOCAL_URL_HOST_PORT: string = "http://172.16.2.46:8080/api/";
    static readonly BASE_URL: string = AppConfig.BASE_LOCAL_URL_HOST_PORT;
